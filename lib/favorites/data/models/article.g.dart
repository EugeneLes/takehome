...
int _articleEstimateSize(
  ...
  bytesCount += 3 +
      SourceSchema.estimateSize(object.source, allOffsets[Source]!, allOffsets);
...
Article _articleDeserialize(
  ...
  object.source = reader.readObjectOrNull<Source>(
        offsets[4],
  ...
  object.urlToImage = reader.readString(offsets[7]);
  return object;
}
...
extension ArticleQueryProperty
  ...
  QueryBuilder<Article, Source, QQueryOperations> sourceProperty() {
    return QueryBuilder.apply(this, (query) {
